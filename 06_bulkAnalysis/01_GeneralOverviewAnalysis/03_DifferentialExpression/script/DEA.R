...
# Export res
saveRDS(res, '06_bulkAnalysis/01_GeneralOverviewAnalysis/03_DifferentialExpression/out/res.rds')
saveRDS(resLFC, '06_bulkAnalysis/01_GeneralOverviewAnalysis/03_DifferentialExpression/out/resLFC.rds')
...
for(comparison in comparisons){
  ...
  ggsave(glue('06_bulkAnalysis/01_GeneralOverviewAnalysis/03_DifferentialExpression/plot/pvalue_histogram_{comparison}.pdf'), 
         width = 10,
         height = 6)
